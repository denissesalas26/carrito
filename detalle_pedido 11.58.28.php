...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h4 class="">Detalle de Pedidos</h4>
                    <div class="card">
                        <div class="card-body">
                        ...
                        <div class="form-group row">
                                ...
                                <input type="number" name="cantidad" class="form-control col-lg-4 col-md-4 col-sm-12" 
                                required>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-md-3 col-sm-12"> Descuentos: </label>
                                <input type="number" name="Fecha_e" class="form-control col-lg-4 col-md-4 col-sm-12" 
                                required>
                            </div>
                            <div class="form-group row">
