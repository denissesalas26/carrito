                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="simpleinput" class="form-control" placeholder="Numero de dni">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-password">Apellido y Nombres</label>
                                            <input type="text" id="example-password" class="form-control" placeholder="ingrese datos">
                                        </div>
                                                
                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Correo Electronnico</label>
                                            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="simpleinput">Telefono</label>
                                            <input type="number" id="simpleinput" class="form-control" placeholder="ingrese datos">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-password">Direccion</label>
                                            <input type="text" id="example-password" class="form-control" placeholder="ingrese datos">
                                        </div>
