              ...
              <div class="card-body">
                ...
                <form action="registrar_usuarios.php" method="post">
                  ...
                  <div class="form-group row ">
                    <label class="col-lg-2 col-md-2 col-sm-12" for="">Fecha_Inicio</label>
                    <input type="date" class="form-control col-lg-4 col-md-4 col-sm-12" name="telefono" placeholder=" " required>

                  </div>

                  <div class="form-group row ">
                    <label class="col-lg-2 col-md-2 col-sm-12" for="">Fecha Fin</label>
                    <input type="date" class="form-control col-lg-4 col-md-4 col-sm-12" name="telefono" placeholder="" required>
                  ...
                  <div class="form-group row ">
                    <label class="col-lg-2 col-md-2 col-sm-12" for="">Fecha_Hora_Reporte</label>
                    <input type="date" class="form-control col-lg-4 col-md-4 col-sm-12" name="telefono" placeholder=" " required>
