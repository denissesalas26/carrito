                    ...
                    <div class="card">
                        ...
                        <form action="Operaciones/registrar_usuario.php" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" name="serie" class="form-control col-lg-4 col-md-5 col-sm-12" 
                                required>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-md-3 col-sm-12"> Número Venta: </label>
                                <input type="number" name="num" class="form-control col-lg-4 col-md-5 col-sm-12" 
                                required>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-md-3 col-sm-12"> Fecha Hora Venta: </label>
